...
$body_user="<!DOCTYPE html><html lang='pl'><head>`n"
$body_user+="<meta content='text/html; charset=utf8' http-equiv='Content-Type' />`n"
$body_user+="<style type='text/css'>table { width: 750px; border-collapse: collapse; margin:1px auto;}"
$body_user+="tr:nth-of-type(odd) { background: #eee;}"
$body_user+="th { background: #3498db; color: white; font-weight: bold; }"
$body_user+="td, th { padding: 10px; border: 1px solid #ccc; text-align: left; font-size: 18px;}}"
$body_user+=".central { text-align: center;}</style>"
$body_user+="</head>"
$body_user+="<body>"
$body_user+="<center><h3>Checklista MDT dla serwera $env:COMPUTERNAME ($localip), stawiany ($d) min</h3>"
$body_user+="<table><thead>"
$body_user+="<tr><th style='width: 291px; height:9px'>Usługa</th><th>Status</th></tr>"
$body_user+="</thead><tbody>"
$body_user+="<tr><td style='width: 291px; height:9px'>Status firewalla:(Stopped)</td><td> $firewall </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Status waitera:(Running)</td><td> $waiter </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>RDP:(OK)</td><td> $rdpstat </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>IIE ESC:(OK)</td><td> $ieesc </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Status IIS:(Started)</td><td> $iis </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Task czyszczenie logów:(Ready)</td><td> $czyszczenie_logow </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Task waiter Schedule:(Ready)</td><td> $waiter_schedule </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Serwer NTP:(ntp.ec.local)</td><td> $ntp </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Windows Update:(aktualny)</td><td> $upd </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Grupy lokalnych adminów: (EC\GRP_IT_CC_Server_Admins)</td><td> $adminilokalni </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Locsvr:(D:\Eurocash\locsvr)</td><td> $env:locsvr</td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Nrhurt:(numer_hurtowni)</td><td> $env:nrhurt</td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Region:(Poland)</td><td> $region </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>NIC_team:(local lub local_team)</td><td> $nic </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>SNMP IP:(10.65.4.15)</td><td> $snmp_ip </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>SNMP Community:(hurtownia_cc)</td><td> $snmp_community </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Czas bezczynności:(5)</td><td> $min </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Status ESET:(Running)</td><td> $ekrn </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Status Win update:(Off)</td><td> $WU </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Status Filezilla:(Running)</td><td> $filezilla </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Maksymalny rozmiar SchadowCopy:(50gb)</td><td> $shadow GB </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Mapowanie:(D:\Eurocash i mapowanie)</td><td> $mapowanie </td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Status licencji windows:(Aktywowany)</td><td> $aktywacja </td></tr>"
$body_user+="</tbody></table></center>"
$body_user+="<center><table><tbody>"
$body_user+="<tr><th style='width: 291px; height:9px'>Do zrobienia</th></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Dodaj hasła do portalu <a href='http://hasla'>hasla</a></td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Ustaw IP dla karty teamingowej</td></tr>"
$body_user+="<tr><td style='width: 291px; height:9px'>Przenieś serwer do OU Workstations/Servers</td></tr>"
$body_user+="</tbody></table></center></body></html>"

# End

# Save as html file
Set-Content "d:\checklista_$date.html" $body_user 
# End

# Send Email
send-mailmessage -from "Dejv MDT <Mail@from.pl>" -to "DejvDzi <xxx@to.pl>" -Encoding ([System.Text.Encoding]::UTF8) -subject $sub -body $body_user -BodyAsHtml -dno onSuccess, onFailure -smtpServer $smtpip
